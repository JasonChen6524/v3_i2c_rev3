...
#if 1
#define SMB0_MASTER_START   0xE0   ///!< start transmitted (master)
#define SMB0_MASTER_TXDATA  0xC0   ///!< data byte transmitted (master)
#define SMB0_MASTER_RXDATA  0x80   ///!< data byte received (master)
#define SMB0_SLAVE_ADDRESS  0x20   ///!< slave address received (slave)
#define SMB0_SLAVE_RX_STOP  0x10   ///!< STOP detected during write (slave)
#define SMB0_SLAVE_RXDATA   0x00   ///!< data byte received (slave)
#define SMB0_SLAVE_TXDATA   0x40   ///!< data byte transmitted (slave)
#define SMB0_SLAVE_TX_STOP  0x50   ///!< STOP detected during a write (slave)
#endif
 ...
 ******************************************************************************/
uint8_t SMB0_getStatusFlag(uint8_t flag);
 ...
 *
 ******************************************************************************/
void SMB0_setStatusFlag(uint8_t flag, uint8_t state);
...
#if 0
#define SMB0_ARBLOST_ERROR   0x00   /// Master lost arbitration on EFM8PDL_SMB0_MASTER_RETRIES consecutive attempts
#define SMB0_NACK_ERROR      0x01   /// Master got a NACK while writing the slave
#define SMB0_UNKNOWN_ERROR   0x02   /// An Unknown error occurred
#define SMB0_TXUNDER_ERROR   0x03   /// Master read more data then is available
#endif
